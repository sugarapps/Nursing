...
def compare_courses_with_openrouter(ua_context, student_context):
    ...
    try:
        ...
        # --- FIX: Combine system and user instructions into a single user prompt ---
        prompt = f"""
        ...
        Based on all the provided information, determine if the applicant's course is an acceptable equivalent.
