...
def get_course_description_from_web(course_row):
    """
    A best-effort web scraper that uses DuckDuckGo to find a course description.
    """
            ...
            with st.expander(f"**{req_name}** ({req_details['ua_course']})", expanded=False):
                ...
                if selected_course_code != '- Not Selected -':
                    ...
                    with col2:
                        ...
                        # --- FIX: Re-introduce automated web search with manual override ---
                        st.markdown("_Attempting to find course description online..._")
                        ...
                        manual_desc = st.text_area(
                            ...
                            value=scraped_desc, # Pre-fill with the scraped result
                            key=f"desc_{req_details['ua_course']}",
                            height=150
                        )
